...
const Appointment = () => {
    return (
        <div style={{
            ...
            <div className=" shadow-xl grid md:grid-cols-2 sm:grid-cols-1 items-center">
                <div className='flex-1 hidden lg:block'>
                    <img src={doctor} alt="" className=' mt-[-150px] ' />
                </div>
                <div className=" flex-1 p-5">
                    <h2 className="text-lx font-bold text-primary mb-2 text-center md:text-left">Appointment</h2>
